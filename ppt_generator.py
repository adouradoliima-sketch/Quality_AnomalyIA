...
def generate_ppt(
    ...
    for slide in prs.slides:
        ...
        print("=" * 60)
        print("Imagem recebida:", image_path)
        print("Existe arquivo?:", os.path.exists(image_path) if image_path else False)
        ...
        if image_path and os.path.exists(image_path):
            ...
            try:
                ...
                print("✅ Imagem adicionada ao slide com sucesso!")
    ...
    filename = OUTPUT_FOLDER / f"{model}_Quality_Report.pptx"

    print("=" * 60)
    print("Salvando PowerPoint em:")
    print(filename)

    prs.save(str(filename))

    print("✅ PowerPoint salvo!")
